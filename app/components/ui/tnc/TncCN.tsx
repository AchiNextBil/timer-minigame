      ...
      <ol>
        <li>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>2026 年 06 月 12 日 00:00:00 – 2026 年 07 月 20 日 23:59:59</td>
              </tr>
            </tbody>
          </table>
        </li>
        <li>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>游戏 1：世界杯知识大比拼</td>
                <td>2026 年 06 月 12 日</td>
                <td>18 元</td>
              </tr>
              <tr>
                <td>游戏 2：8.88 秒 挑战赢奖金</td>
                <td>2026 年 06 月 22 日</td>
                <td>8 元 - 36 元</td>
              </tr>
              <tr>
                <td>游戏 3：点球大战</td>
                <td>2026 年 06 月 29 日</td>
                <td>6 元 - 18 元</td>
              </tr>
            </tbody>
          </table>
        ...
        {/* 5 */}
        <li>
          此优惠当日需要存款至少 888 元并参与游戏，经过审核后将派发奖金给首 888
          名符合条件的会员，先到先得，派完为止。
        </li>
        {/* 6 */}
        <li>
